#
#  Be sure to run `pod spec lint HYSDoctorTool.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/RMJKDevelopment/HYSDoctorSDK.git", :tag => "#{spec.version}" }
